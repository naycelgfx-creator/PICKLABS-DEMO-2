import{r as s,j as e}from"./index-DK2SO0gn.js";import{L as v}from"./LiveTicketPanel-CAk6evoQ.js";import"./data-player-db-BKCVVeKs.js";const b=[{team:"Lakers",line:"-4.5",type:"lime-glow"},{team:"Warriors",line:"+2.0",type:"orange-outline"}],E=({activeTickets:p})=>{const[l,c]=s.useState(!1),[f,n]=s.useState(!0),d=s.useRef([]);s.useEffect(()=>{typeof DeviceOrientationEvent<"u"&&typeof DeviceOrientationEvent.requestPermission=="function"?n(!0):(n(!1),c(!0))},[]);const x=t=>{let r=t.gamma||0,i=t.beta||0;r=Math.max(-45,Math.min(45,r)),i=Math.max(-45,Math.min(45,i));const o=(r+45)/90*100,h=(i+45)/90*100;d.current.forEach(a=>{a&&(a.classList.add("is-active"),a.style.setProperty("--x",`${o}%`),a.style.setProperty("--y",`${h}%`))})},m=t=>{if(!l)return;const r=t.clientX/window.innerWidth*100,i=t.clientY/window.innerHeight*100;d.current.forEach(o=>{o&&(o.classList.add("is-active"),o.style.setProperty("--x",`${r}%`),o.style.setProperty("--y",`${i}%`))})};s.useEffect(()=>(l&&(window.addEventListener("deviceorientation",x),window.addEventListener("mousemove",m)),()=>{window.removeEventListener("deviceorientation",x),window.removeEventListener("mousemove",m)}),[l]);const u=()=>{typeof DeviceOrientationEvent<"u"&&typeof DeviceOrientationEvent.requestPermission=="function"?DeviceOrientationEvent.requestPermission().then(t=>{t==="granted"?(c(!0),n(!1)):alert("Permission denied. 3D features will be disabled.")}).catch(console.error):(c(!0),n(!1))};return e.jsxs("div",{className:"w-full min-h-[calc(100vh-200px)] flex flex-col items-center justify-start gap-8 bg-[#151518] p-6 pt-24 font-sans text-white relative overflow-hidden",children:[e.jsx("div",{className:"absolute top-6 right-6 z-[100] h-10 w-full max-w-sm",children:e.jsx(v,{activeTickets:p})}),e.jsx("style",{dangerouslySetInnerHTML:{__html:`
                .tilt-card {
