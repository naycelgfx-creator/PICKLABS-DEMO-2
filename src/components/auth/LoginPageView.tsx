                        ...
                        <div className="space-y-4 pt-1">
                            <div className="space-y-1">
                                ...
                                <input
                                    ...
                                    placeholder="operator@picklabs.ai"
                                    className="w-full bg-neutral-900 border border-border-muted text-sm font-bold text-text-main rounded-xl py-3 px-4 focus:ring-1 focus:ring-primary outline-none transition-colors"
                                    required
                                />
                            </div>
                            <div className="space-y-1">
                            ...
                            <div className="space-y-3">
                                <button type="button" className="social-btn w-full flex items-center justify-center gap-3 bg-neutral-900 border border-border-muted hover:border-primary/50 text-white font-bold text-sm py-3 rounded-xl transition-all">
