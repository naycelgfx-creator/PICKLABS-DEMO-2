...
const NBA_FRANCHISE_DATA: Record<string, FranchiseData> = {
    // Atlantic
    BOS: { founded: 1946, city: 'Boston', championships: 18, championshipYears: [1957, 1959, 1960, 1961, 1962, 1963, 1964, 1965, 1966, 1968, 1969, 1974, 1976, 1981, 1984, 1986, 2008, 2024], conference: 'Eastern', division: 'Atlantic', arena: 'TD Garden', bio: 'The Boston Celtics are the most decorated franchise in NBA history. Founded in 1946, the C\'s built a dynasty under legendary coach Red Auerbach and center Bill Russell, winning eight consecutive championships from 1959–1966. The franchise has produced Hall of Famers like Larry Bird, Kevin McHale, and Paul Pierce. In 2024, Jayson Tatum and Jaylen Brown led Boston to a dominant championship run, capturing a record 18th title. The defending champion Celtics enter the 2025–26 season as one of the league\'s elite teams.', colors: ['#007A33', '#BA9653'] },
    ...
    IND: { founded: 1967, city: 'Indianapolis', championships: 0, championshipYears: [], conference: 'Eastern', division: 'Central', arena: 'Gainbridge Fieldhouse', bio: 'The Indiana Pacers, ABA alumni who joined the NBA in 1976, have been one of the league\'s most resilient franchises. Built around Reggie Miller\'s legendary shooting, the Pacers are back in the spotlight with Tyrese Haliburton leading an elite, pass-first offense. After a heartbreaking 2025 Finals appearance — falling to OKC in six games — Indiana enters 2025–26 hungry for their first championship.', colors: ['#002D62', '#FDBB30'] },
    ...
    MIN: { founded: 1989, city: 'Minneapolis', championships: 0, championshipYears: [], conference: 'Western', division: 'Northwest', arena: 'Target Center', bio: 'The Minnesota Timberwolves found their greatest success with the Kevin Garnett–era teams of the early 2000s. Anthony Edwards — one of the most electrifying players in the game — has transformed the franchise into a perennial playoff contender. Minnesota assembled a deep, versatile roster around "Ant," cementing the Twin Cities as legitimate title contenders in 2025–26.', colors: ['#0C2340', '#236192'] },
    OKC: { founded: 1967, city: 'Oklahoma City', championships: 2, championshipYears: [1979, 2025], conference: 'Western', division: 'Northwest', arena: 'Paycom Center', bio: 'The Oklahoma City Thunder completed one of the most remarkable rises in NBA history. In 2025, under MVP coach Mark Daigneault and led by Finals MVP Shai Gilgeous-Alexander, OKC captured the franchise\'s first NBA title since the Seattle SuperSonics era (1979), defeating the Indiana Pacers in six games. SGA\'s dominant scoring and IQ-driven play cemented him as the best player in the world. As back-to-back champions in 2025–26, Oklahoma City is the class of the Western Conference.', colors: ['#007AC1', '#EF3B24'] },
    ...
    // Southwest
    DAL: { founded: 1980, city: 'Dallas', championships: 1, championshipYears: [2011], conference: 'Western', division: 'Southwest', arena: 'American Airlines Center', bio: 'The Dallas Mavericks delivered one of the greatest upsets in Finals history in 2011, with Dirk Nowitzki\'s iconic performance cementing him as the greatest European player in NBA history. Today, Luka Dončić has elevated Dallas back into championship contention — his playmaking, scoring and clutch performances make him one of the most gifted offensive players the league has ever seen. The Mavs are a perennial Western Conference threat in 2025–26.', colors: ['#00538C', '#002B5E'] },
