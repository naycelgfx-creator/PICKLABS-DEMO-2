...
export const REAL_TEAMS: Record<string, { name: string, abbr: string, type?: 'team' | 'player', url?: string, league?: string }[]> = {
    ...
    NCAAB: [
        { name: 'Arkansas', abbr: 'ark', url: 'https://a.espncdn.com/i/teamlogos/ncaa/500/8.png' },
        { name: 'Arizona', abbr: 'ariz', url: 'https://a.espncdn.com/i/teamlogos/ncaa/500/12.png' },
        { name: 'Clemson', abbr: 'clem', url: 'https://a.espncdn.com/i/teamlogos/ncaa/500/228.png' },
        { name: 'Florida', abbr: 'fla', url: 'https://a.espncdn.com/i/teamlogos/ncaa/500/57.png' },
        ...
        { name: 'Miami (FL)', abbr: 'mia', url: 'https://a.espncdn.com/i/teamlogos/ncaa/500/2390.png' },
        { name: 'Mississippi St', abbr: 'msst', url: 'https://a.espncdn.com/i/teamlogos/ncaa/500/344.png' },
        { name: 'North Carolina', abbr: 'unc', url: 'https://a.espncdn.com/i/teamlogos/ncaa/500/153.png' },
        { name: 'Oklahoma', abbr: 'okla', url: 'https://a.espncdn.com/i/teamlogos/ncaa/500/201.png' },
        { name: 'Ole Miss', abbr: 'miss', url: 'https://a.espncdn.com/i/teamlogos/ncaa/500/145.png' },
        { name: 'Oregon State', abbr: 'orst', url: 'https://a.espncdn.com/i/teamlogos/ncaa/500/204.png' },
        { name: 'Stanford', abbr: 'stan', url: 'https://a.espncdn.com/i/teamlogos/ncaa/500/24.png' },
        { name: 'Tennessee', abbr: 'tenn', url: 'https://a.espncdn.com/i/teamlogos/ncaa/500/2633.png' },
        { name: 'Texas', abbr: 'tex', url: 'https://a.espncdn.com/i/teamlogos/ncaa/500/251.png' },
        { name: 'Texas A&M', abbr: 'tamu', url: 'https://a.espncdn.com/i/teamlogos/ncaa/500/245.png' },
        { name: 'UCLA', abbr: 'ucla', url: 'https://a.espncdn.com/i/teamlogos/ncaa/500/26.png' },
        { name: 'Vanderbilt', abbr: 'van', url: 'https://a.espncdn.com/i/teamlogos/ncaa/500/238.png' }
    ],
    WNBA: [
...
const generateDummyGames = (sport: string, count: number): Game[] => {
    ...
    return Array.from({ length: count }).map((_, i) => {
        ...
        return {
            ...
            timeLabel: isLive ? (sport === 'UFC' ? `Round ${Math.floor(Math.random() * 3) + 1} • In Progress` : sport === 'NCAAM' || sport === 'NBA' ? `H${Math.floor(Math.random() * 2) + 1} • 0${Math.floor(Math.random() * 9)}:${Math.floor(Math.random() * 60)}` : sport === 'NCAAB' || sport === 'MLB' ? `Bot ${Math.floor(Math.random() * 9) + 1} • In Progress` : `Q${Math.floor(Math.random() * 4) + 1} • 0${Math.floor(Math.random() * 9)}:${Math.floor(Math.random() * 60)}`) : `Today • 0${Math.floor(Math.random() * 9) + 1}:00 PM`,
